...
namespace LeaveManagement.Web.Controllers
{
    ...
    public class LeaveRequestsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken] //formdan post yapiyoruz, antiforgery korumasi ekle
        ...
        public async Task<IActionResult> Cancel(int id)
        {
            try
            {
                await leaveRequestRepository.CancelLeaveReqest(id);
            }
            catch (Exception e)
            {
                throw;
        ...
        public IActionResult Create()
        {
            ...
            {
                //view de dropdown da idler leave type name i gostersin
